<div wire:poll.5s>
    ...
    {{-- Executions + Opportunities side by side --}}
    <div class="grid grid-cols-1 gap-8 xl:grid-cols-2">
        ...
        <div class="min-w-0">
            <flux:heading size="lg">Detected Opportunities</flux:heading>
            <flux:text class="mt-1 mb-6">Arbitrage opportunities found across exchanges</flux:text>
